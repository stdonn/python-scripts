...
if __name__ == '__main__':
	if len(sys.argv) < 2:
		print("Wrong number of arguments. Usage: Split_GOCAD_PLines.py <InputFile.ts>! Canceling...")
		sys.exit(1)
